...
const listColumns = [
  ...
  Columns.custom.sortable(
    (text, item) => {
      const labelClass = `pastel-label ${
        ["redshift", "athena", "rds_mysql", "pg", "mysql"].includes(item.data_source_type)
          ? item.data_source_type
          : "default"  // 기본값으로 회색 파스텔톤 적용
      }`;
      return(
      <React.Fragment>
        ...
        <span className={labelClass}>
            <QuerySourceTypeIcon
              ...
              aria-label={item.data_source_name}
              title={item.data_source_name}
            />
