...
(
    255
) NOT NULL COMMENT '통화 쌍 (예: USD/KRW)',
    base_currency VARCHAR
(
    10
) NOT NULL COMMENT '기준 통화 (예: USD)',
    quote_currency VARCHAR
(
    10
) NOT NULL COMMENT '상대 통화 (예: KRW)',
    exchange_date DATE NOT NULL COMMENT '환율 적용 날짜',
    open_rate DECIMAL
(
    15,
    6
) NOT NULL COMMENT '개장가',
    close_rate DECIMAL
(
    15,
    6
...
(
    15,
    6
) NOT NULL COMMENT '최고가',
    low_rate DECIMAL
(
    15,
    6
) NOT NULL COMMENT '최저가',
...
(
    ...
    UNIQUE KEY unique_currency_date
(
    currency_pair,
    exchange_date
)
